...
areadict: Dict[Area, List[Conference]] = {
    ...
    # HCI venues added for HCIRankings
    Area("cscw"): [
        Conference("CSCW"),
        # PACMHCI (Proc. ACM Hum. Comput. Interact.) is handled separately via pacmhci area
    ],
    Area("pacmhci"): [Conference("Proc. ACM Hum. Comput. Interact.")],
    Area("assets"): [Conference("ASSETS")],
    Area("dis"): [
        Conference("DIS"),
        Conference("Conference on Designing Interactive Systems"),
        Conference("Symposium on Designing Interactive Systems"),
    ],
    Area("tei"): [Conference("TEI")],
    Area("iss"): [Conference("ISS"), Conference("ITS")],
    Area("iui"): [Conference("IUI")],
    Area("mobilehci"): [Conference("MobileHCI")],
    Area("chiplay"): [Conference("CHI PLAY")],
    Area("hri"): [Conference("HRI")],
    Area("cc"): [Conference("Creativity & Cognition")],
    Area("vrst"): [Conference("VRST")],
    Area("eics"): [Conference("EICS")],
    Area("interact"): [
        Conference("INTERACT"),
        Conference("INTERACT (1)"),
        Conference("INTERACT (2)"),
        Conference("INTERACT (3)"),
        Conference("INTERACT (4)"),
        Conference("INTERACT (5)"),
    ],
    Area("tochi"): [Conference("ACM Trans. Comput. Hum. Interact.")],
    Area("ijhcs"): [Conference("Int. J. Hum. Comput. Stud.")],
    ...
    Area("mm"): [Conference("MM")],
    Area("icmi"): [Conference("ICMI")],
...
# PACMHCI (Proc. ACM Hum. Comput. Interact.) issue number -> area mapping.
# The PACMHCI journal publishes proceedings from multiple HCI conferences.
# Issue numbers identify the originating conference.
PACMHCI_NUMBER_TO_AREA: Dict[str, Area] = {
    "CSCW":     Area("cscw"),
    "CSCW1":    Area("cscw"),
    "CSCW2":    Area("cscw"),
    "CSCW3":    Area("cscw"),
    "ISS":      Area("iss"),
    "CHI PLAY": Area("chiplay"),
    "EICS":     Area("eics"),
}
...
def countPaper(
    ...
    if pageCount != -1 and pageCount < pageCountThreshold:
        ...
        # HCI journals use article numbers (e.g., "102922") instead of page ranges;
        # pagecount() returns 0 for these, but all published articles are full papers.
        exceptionConference |= confname == "Int. J. Hum. Comput. Stud."
        exceptionConference |= confname == "ACM Trans. Comput. Hum. Interact."
        exceptionConference |= confname == "Behav. Inf. Technol."
        exceptionConference |= confname == "Int. J. Hum. Comput. Interact."
