...
BOOKTITLES = frozenset([
    ...
    "ASSETS", "DIS", "Conference on Designing Interactive Systems",
    "Symposium on Designing Interactive Systems",
    "TEI", "ISS", "ITS", "IUI", "MobileHCI",
    "CHI PLAY", "HRI", "Creativity & Cognition", "VRST", "EICS",
    "INTERACT", "INTERACT (1)", "INTERACT (2)", "INTERACT (3)", "INTERACT (4)", "INTERACT (5)",
    "ISMAR",
    "COMPASS",
    "ETRA",
    "RecSys",
...
JOURNALS = frozenset([
    ...
    # HCI journals
    "Proc. ACM Hum. Comput. Interact.",   # PACMHCI: CSCW 2018+, ISS, GROUP, etc.
